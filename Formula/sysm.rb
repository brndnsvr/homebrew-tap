...
class Sysm < Formula
  ...
  version "1.26.3.2"
  url "https://github.com/brndnsvr/sysm/releases/download/v1.26.3.2/sysm-1.26.3.2-macos-arm64.tar.gz"
  ...
  resource "claude-skill" do
    url "https://github.com/brndnsvr/sysm/releases/download/v1.26.3.2/sysm.skill"
